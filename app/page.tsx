        ...
        <div className="pt-20 pb-20 md:pb-6">
          {activeSection === 'dashboard' && (
            <>
              ...
              <div className="fixed top-20 left-0 right-0 z-20 bg-white/95 backdrop-blur-sm border-b border-gray-200/50">
                    ...
                    <div 
                      ...
                      style={{
                        background: `linear-gradient(135deg, ${stat.color.replace('bg-', '') === 'blue-400' ? '#60A5FA' : 
                                                             ...
                                                             stat.color.replace('bg-', '') === 'red-400' ? '#F87171' : '#60A5FA'} 0%, 
                                                             ...
                                                             stat.color.replace('bg-', '') === 'red-400' ? '#EF4444' : '#3B82F6'} 100%)`,
        ...
        {activeSection === 'live-map' && (
          <div className="px-4">
            <div className="bg-white/90 backdrop-blur-md rounded-lg p-6 shadow-sm border border-white/60">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Live Map View</h2>
              <div className="bg-gray-200 rounded-lg h-64 flex items-center justify-center">
                <div className="text-center">
                  <i className="ri-map-pin-line text-4xl text-gray-400 mb-2"></i>
                  <p className="text-gray-600">Interactive Map Coming Soon</p>
                  <p className="text-sm text-gray-500 mt-1">Real-time vehicle tracking</p>
                </div>
              </div>
              <div className="mt-4 grid grid-cols-2 gap-4">
                ...
                <div className="bg-green-50 p-3 rounded-lg">
                  ...
                  <div className="text-2xl font-bold text-green-600">156 km</div>
                </div>
              </div>
            </div>
          </div>
